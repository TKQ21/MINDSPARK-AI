...
import { Plus, MessageSquare, Trash2, Sparkles, LogOut, User } from "lucide-react";
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed md:relative z-50 md:z-auto top-0 left-0 h-full w-[280px] flex flex-col"
        style={{
